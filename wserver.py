...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/15a893963f42e71af1fc3.png" type="image/jpg">
    <script
...
async def homepage(request):
    ...
    return web.Response(text="<h1>Stormbreaker Mirror Bot</h1>",content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>Stormbreaker Mirror Bot</h3>", content_type="text/html")
            return response
